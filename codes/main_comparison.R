...
comp.file <- "inputs/LAMA_BS_Xmas.csv" # set location of the accelerator merge file!!!
output.label <- "_Xmas" #all outputs will end end with that label (except plots to avoid duplicates)
output.folder <- "dec17" #subfolder name in outputs and plots folder for versioning
